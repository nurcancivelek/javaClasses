...
public class Card {
	/*
	 * define a class with 2 methods and this class should have 4 subclasses in which
	 * some behavior can be overridden some can implement its own behavior
	 */
	
	public void chargeInterest() {
		System.out.println("Card charges 25% interest");
	}
	public void creditLimit() { //overrridden in ax class
...
class AX extends Card {
	...
	public void creditLimit() {// overriding here
