...
public class SplitMethod2 {
	...
	public static void main(String[] args) {
		//toCharArray() will return always OneDimension Array
		//we can change the “\\.” to “\\,” or ” \\:” etc… right?
		//how many clauses are there in the following string
        ...
        String[] array =str.split(",");//to separate clauses ","is used.
