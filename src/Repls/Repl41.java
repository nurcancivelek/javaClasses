...
//		Let us consider there are three students in the class with roll number
		//starting from (101 to 103) if any number other than 101-103 
		//are present display "Not found Student name: in Class"
//
...
//		Other than this roll number  it should print "Not found Student name: in Class"
		...
		switch(student) {
		case 101: name="Ramesh";
			break;
		case 102: name="Mahesh";
			break;
		case 103: name="Mukesh";
			break;
		default: name="Not found Student name: in Class";
			break;
		}
